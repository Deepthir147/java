...
import com.xworkz.allprojects.app.inheritance.SetterandGetterMethod.app.Uber;
...
public class UberRunner {
			...
			public static void main(String[] args) {
				...
				uber.setPassengerName("Deepthi");
				uber.setDriverName("Ram");
				uber.setSourceLocation("Tunkur");
